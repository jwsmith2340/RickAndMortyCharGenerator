...
//     let randomNum = Math.floor(Math.random() * nameArray.length)
    //console.log(randomNum);   random num between 1 and 826
    //console.log(nameArray[randomNum])   Logs random array between 1 and 826
...
$('#pickleRick').on('click', function(listener){
    ...
    //console.log(testFirstFix)
    let testSecondFix = testFirstFix.split('-').join('+')
    //console.log(testSecondFix)
